<?php
    ...
    $query = "SHOW TABLES LIKE 'admintbl'";
    ...
    $query = "SELECT * FROM admintbl WHERE id = 1";
    $result = $conn->query($query);

    if ($result->num_rows == 0) {
        $insertAdminDataQuery = "INSERT INTO admintbl (id, username, password, role_id)
        VALUES
            (1, 'AdminPrince', '" . md5('password1') . "', 1)";
        $conn->query($insertAdminDataQuery);
    }
...
<body>
    ...
    <h1 id="adminLoginHeader">Welcome Admin!</h1>
